...
public class Crossroad {
    ...
    /**
     * Create a crossroad runner for the given node identifier.
     *
     * @param crossroad the {@link Node.NodeEnum} representing this crossroad
     */
     ...
     *
     * This method creates a {@link Utils.RoundRobin} coordinator, per-road
     * synchronized queues for arriving and passed vehicles, and spawns
     * {@link Traffic.PassRoad} and {@link Traffic.TrafficLight} threads for
     * each incoming road. A single {@link Comunication.Receiver} and
     * {@link Traffic.TrafficSorter} are also started to distribute arriving
     ...
     *
     * @param args argument with the crossroad identifier (e.g. "CR1")
     */
    public static void main(String[] args) {
        ...
        Crossroad crossroadObj = new Crossroad(crossroad);
        crossroadObj.start();
    }
}
